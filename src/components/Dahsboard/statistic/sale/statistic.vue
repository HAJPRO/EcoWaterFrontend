...
const { metrics, barSeries, lineSeries, TopDrivers } = storeToRefs(
        ...
        <el-table-column label="Xodim" width="250">
          <template #default="{ row }">
            <div class="relative group flex items-center gap-3 cursor-pointer">
              ...
              <!-- Kattalashtirilgan rasm (hover qilinganda chiqadi) -->
              <div
                class="absolute top-0 left-14 z-60 hidden group-hover:block"
