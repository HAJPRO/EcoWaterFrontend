...
const { detail_weaving_modal, detail } = storeToRefs(store_provide);
...
const confirm = () => {
  store_provide.Confirm({ department: 3, delivered: false });
};
const delivered = () => {
  store_provide.Confirm({ department: 3, delivered: true });
};
...
<template>
  <div>
    <el-dialog v-model="detail_weaving_modal" width="1000">
      <span>
