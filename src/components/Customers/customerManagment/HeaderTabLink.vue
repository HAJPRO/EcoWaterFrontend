...
const { all_length, customers } = storeToRefs(store_managment);
  ...
  >
    <div class="col-span-12 grid-flow-col flex-wrap">
      ...
      <router-link
        ...
        class="inline-flex text-[12px] items-center mr-2 px-4 py-1 mb-1 font-medium text-center text-red hover:border-b-2 border-solid border-[#36d887] bg-[#e4e9e9] text-bold rounded"
      >
        <i class="fa-solid fa-truck-fast mr-2 fa-xm"></i>
        Distributorlar
        <div class="flex flex-shrink-0 ml-2">
          <span
      ...
      <router-link
        ...
        class="inline-flex text-[12px] items-center mr-2 px-4 py-1 mb-1 font-medium text-center text-red hover:border-b-2 border-solid border-[#36d887] bg-[#e4e9e9] text-bold rounded"
      >
        <i class="fa-solid fa-store mr-2 fa-xm"></i> Do‘konlar
        <div class="flex flex-shrink-0 ml-2">
          <span
      ...
      <router-link
        ...
        class="inline-flex text-[12px] items-center mr-2 px-4 py-1 mb-1 font-medium text-center text-red hover:border-b-2 border-solid border-[#36d887] bg-[#e4e9e9] text-bold rounded"
      >
        <i class="fa-solid fa-building mr-2 fa-xm"></i> Offislar
        <div class="flex flex-shrink-0 ml-2">
          <span
       ...
       <router-link
        ...
        class="inline-flex text-[12px] items-center mr-2 px-4 py-1 mb-1 font-medium text-center text-red hover:border-b-2 border-solid border-[#36d887] bg-[#e4e9e9] text-bold rounded"
      >
        <i class="fa-solid fa-user-plus mr-2 fa-xm"></i> Yangi mijozlar
        <div class="flex flex-shrink-0 ml-2">
          <span
      ...
      <router-link
        ...
        class="inline-flex text-[12px] items-center mr-2 px-4 py-1 mb-1 font-medium text-center text-red hover:border-b-2 border-solid border-[#36d887] bg-[#e4e9e9] text-bold rounded"
      >
        <i class="fa-solid fa-user-check mr-2 fa-md"></i> Faol mijozlar
        <div class="flex flex-shrink-0 ml-2">
          <span
       ...
       <router-link
        ...
        class="inline-flex text-[12px] items-center mr-2 px-4 py-1 mb-1 font-medium text-center text-red hover:border-b-2 border-solid border-[#36d887] bg-[#e4e9e9] text-bold rounded"
      >
        <i class="fa-solid fa-file-invoice-dollar mr-2 fa-md"></i> Debitorlar
        <div class="flex flex-shrink-0 ml-2">
          <span
